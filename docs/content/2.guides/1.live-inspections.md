...
::note
Live inspections require enabled [Nuxt DevTools](https://devtools.nuxt.com/).
::
...
Live Inspections require enabled Nuxt DevTools, plus `showLiveInspections` set to `true`:
