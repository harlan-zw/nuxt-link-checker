...
The module runs 13 inspections covering broken links, SEO best practices, and accessibility. To disable any rule, add it to `skipInspections` in your config.

## Rule Categories

| Category | Rules |
|----------|-------|
| Broken Links | `no-error-response`, `missing-hash` |
...
Ensuring that internal links do not lead to error responses improves the user experience and improves
your sites crawlability.
