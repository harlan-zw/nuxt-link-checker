...
You can embed these in your CI/CD pipeline to help you avoid deploying broken links.
...
Configure these using [site config](/docs/site-config/guides/setting-site-config) instead.
