...
Whether link checking should fetch remote (external) URLs. When enabled, the module checks if you are online before fetching. Disable this if you are working offline or want to skip external URL validation.
