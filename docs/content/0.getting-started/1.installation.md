...
1. Check which [Inspection Rules](/docs/link-checker/guides/rules) the module enables by default
2. Use Nuxt Sitemap so that the module automatically discovers your page links.
3. Learn more about how [Web Crawlers](/learn/controlling-crawlers) interact with your site.
